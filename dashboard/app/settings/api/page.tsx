        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition-colors text-white"
                >
                    Create API Key
                </button>
            </div>
                        ...
                        <SettingsCard title="API Usage" description="Your API usage this month">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="p-4 bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-lg border border-purple-800/30">
                                    ...
                                    <p className="text-3xl font-bold text-white">{usageStats.total_requests.toLocaleString()}</p>
                                </div>
                    ...
                    <SettingsCard title="API Keys" description={`${apiKeys.length} key${apiKeys.length !== 1 ? 's' : ''}`}>
                        {apiKeys.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <button
                                    onClick={() => setShowCreateModal(true)}
                                    className="mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition-colors text-white"
                                >
                        ...
                        {newKeyData ? (
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            readOnly
                                            className="flex-1 px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-white font-mono text-sm"
                                        />
                                        <button
                                ...
                                <button
                                    ...
                                    className="w-full px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg font-medium transition-colors text-white"
                                >
                                    Done
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        {...register('name')}
                                        className="w-full px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-500"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white"
                                    >
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={creating}
                                        className="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed rounded-lg font-medium transition-colors text-white"
                                    >
