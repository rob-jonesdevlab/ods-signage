    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                {/* Main Content Area */}
                <div className="flex-1 flex flex-col gap-4 p-6 md:p-8 overflow-y-auto">
                    {/* Page Header */}
            ...
            {/* URL Modal - Keeping existing implementation */}
            {
                showUrlModal && (
                    ...
                    >
                        <div
                            className="relative w-full max-w-lg bg-white border border-gray-200 rounded-xl shadow-2xl"
                            onClick={(e) => e.stopPropagation()}
                        >
                            {/* Header */}
                            <div className="flex items-start justify-between p-6 border-b border-gray-200">
                                <div className="flex flex-col gap-1">
                                    <h2 className="text-2xl font-semibold tracking-tight text-gray-900">Add URL Content</h2>
                                    <p className="text-gray-500 text-sm">Add an external URL to your content library</p>
                                </div>
                                <button
                                    onClick={() => setShowUrlModal(false)}
                            ...
                            <form onSubmit={handleUrlSubmit} className="p-6 space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                                ...
                                <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 border border-gray-200">
                                    ...
                                    <label htmlFor="isNonStop" className="flex-1 cursor-pointer">
                                        <div className="text-sm font-medium text-gray-700">Non-stop / Infinite Loop</div>
                                        <div className="text-xs text-gray-500">Display this URL continuously without rotation</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                        min="1"
                                        max="3600"
                                ...
                                <div className="flex items-center gap-3 pt-4">
                                    <button
                                        type="button"
                                        onClick={() => setShowUrlModal(false)}
                                        className="flex-1 px-5 h-11 rounded-lg text-gray-700 bg-gray-200 hover:bg-gray-300 transition-all text-sm font-medium border border-gray-300"
                                    >
                                        Cancel
                                    </button>
                                    <button
                ...
                selectedContent && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between p-6 border-b border-gray-200">
                                <div className="flex flex-col gap-1">
                                    <h2 className="text-2xl font-semibold tracking-tight text-gray-900">{selectedContent.name}</h2>
                            ...
                            <div className="flex-1 overflow-y-auto p-6">
                                ...
                                {/* Metadata */}
                                <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">File Metadata</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-0 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6 border-b border-gray-200 md:border-r">
                                        ...
                                        <span className="text-gray-900 text-sm font-medium capitalize">{selectedContent.type}</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6 border-b border-gray-200">
                                        <span className="text-gray-500 text-sm">Duration</span>
                                        <span className="text-gray-900 text-sm font-medium">{selectedContent.duration} seconds</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6 border-b border-gray-200 md:border-r">
                                        <span className="text-gray-500 text-sm">Size</span>
                                        <span className="text-gray-900 text-sm font-medium">{formatFileSize(selectedContent.metadata.size)}</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6 border-b border-gray-200">
                                        <span className="text-gray-500 text-sm">Uploaded</span>
                                        <span className="text-gray-900 text-sm font-medium">{formatDate(selectedContent.metadata.uploadedAt)}</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6 md:border-r">
                                        ...
                                        <span className="text-gray-900 text-sm font-medium">{selectedContent.uploaded_by || 'System'}</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 px-6">
                                        ...
                                        <span className="text-gray-900 text-sm font-medium">{selectedContent.metadata.mimeType}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col-reverse sm:flex-row items-center justify-between p-6 bg-gray-50 border-t border-gray-200 rounded-b-xl gap-4">
                                ...
                                <div className="flex items-center gap-3 w-full sm:w-auto">
                                    <button
                                        onClick={() => setSelectedContent(null)}
                                        className="px-5 h-10 w-full sm:w-auto rounded-lg text-gray-700 bg-gray-200 hover:bg-gray-300 transition-all text-sm font-medium shadow-sm border border-gray-300"
                                    >
                                        Close
                                    </button>
