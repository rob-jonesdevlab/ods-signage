...
export default function EmptyState({
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] text-center p-8 relative rounded-2xl overflow-hidden border border-gray-200 bg-white/50 backdrop-blur-sm">
            {/* Decorative Background Glow */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] opacity-50"></div>
                <div className="w-[300px] h-[300px] bg-purple-500/10 rounded-full blur-[80px] absolute translate-y-10 opacity-40"></div>
            </div>
            ...
            <div className="relative z-10 mb-8 group/icon">
                ...
                <div className="relative bg-white p-6 rounded-3xl shadow-xl shadow-blue-600/5 ring-1 ring-gray-200">
            ...
            {showSecondaryActions && (
                <div className="relative z-10 mt-12 flex items-center gap-6 text-sm text-gray-500">
                    <a
                        href="#"
